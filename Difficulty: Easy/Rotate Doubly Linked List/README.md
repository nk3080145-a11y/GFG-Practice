...
<pre><span style="font-size: 14pt;"><strong>Input: </strong>head =<strong> </strong>[1, 2, 3], k = 2
<strong>Output:</strong> 3 &lt;-&gt; 1 &lt;-&gt; 2</span></pre></div><br><p><span style=font-size:18px><strong>Topic Tags : </strong><br><code>Doubly Linked List</code>&nbsp;<code>Linked List</code>&nbsp;